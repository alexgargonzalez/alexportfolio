      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        >
          ...
          <motion.a
            ...
            className="flex-1 flex flex-col justify-between items-center text-center p-8 rounded-3xl border border-foreground/5 bg-surface-subtle shadow-sm transition hover:border-emerald-500/30 hover:bg-emerald-500/[0.02] hover:shadow-md active:scale-[0.98] group"
          >
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex flex-col justify-between items-center text-center p-8 rounded-3xl border border-foreground/5 bg-surface-subtle shadow-sm transition hover:border-brand-accent/30 hover:bg-accent-soft hover:shadow-md active:scale-[0.98] group"
          >
